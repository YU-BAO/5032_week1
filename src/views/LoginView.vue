      ...
      <div class="row justify-content-center">
        <div class="col-12 col-lg-5">
          ...
          <div class="text-center mb-5">
            <h1 class="page-title mb-3">User Login</h1>
            <p class="page-subtitle">Sign in to access your library account</p>
          </div>
            ...
            <form @submit.prevent="loginUser">
              ...
              <div class="mb-4">
                ...
                <input 
                  ...
                  @blur="() => validateIdentifier(true)"
                  @input="() => validateIdentifier(false)"
...
const validateIdentifier = (blur) => {
  const identifier = loginForm.value.identifier.trim()
  if (!identifier) {
    if (blur) errors.value.identifier = "Username or email is required"
  } else if (identifier.length < 3) {
    if (blur) errors.value.identifier = "Username or email must be at least 3 characters"
  } else {
...
const loginUser = () => {
  ...
  if (!hasErrors) {
    ...
    import('../firebase/auth').then(({ loginUser: firebaseLogin }) => {
      firebaseLogin(loginForm.value.identifier.trim(), loginForm.value.password)
        .then(result => {
          if (result.success) {
            // Create session data
            const sessionData = {
